...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'github_api' => 'getGithubApiService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('p+hk0zIlc-', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('J-g92U24Jj', 0, 'kE+oOCAZPU27YDUj6CAymF', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9440d7fb73a042007d11f12e470fb0bf76fd195836415757fe664b1322af7693');
    ...
    /**
     * Gets the 'github_api' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\GitHubApi A AppBundle\Service\GitHubApi instance
     */
    protected function getGithubApiService()
    {
        return $this->services['github_api'] = new \AppBundle\Service\GitHubApi();
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('84102c8dab7523388934b199cdeed8644f57579d');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QeKCaYkPkD', 0, 'kE+oOCAZPU27YDUj6CAymF', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('591a55567f6389.27394628')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '84102c8dab7523388934b199cdeed8644f57579d',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '84102c8dab7523388934b199cdeed8644f57579d',
